...
class FlexibleTimeframeAnalyzer:
    ...
    def run_analysis(self):
        ...
        # Compute unified Layer 2 (includes all ERI/EVI/RF + Temporal Intelligence)
        ...
        # Compute Layer 2 output (formerly Layer 2 + Layer 3)
        ...
        # Save output to CSV for inspection
