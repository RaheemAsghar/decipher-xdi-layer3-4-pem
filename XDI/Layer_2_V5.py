...
class Layer2Computer:
    ...
    def _derive_temporal_intelligence_from_tiers(self, by_tier: dict, all_tiers: list) -> dict:
        ...
        Compares early tiers (Tier_4, Tier_5) vs recent tiers (Tier_1, Tier_2)
            ...
            # Emotion composition flow (uses existing momentum + new summaries)
    ...
    def _compute_emotion_flow(
            ...
            Uses existing _aggregate_emotions_from_tiers() +
            _calculate_emotion_momentum() and adds structure on top.
            """
    ...
    self, by_tier: dict, recent_tiers: list, early_tiers: list, all_tiers: list) -> dict:
        """
